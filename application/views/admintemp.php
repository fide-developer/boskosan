	...
	<nav id="navoffset">
		...
		<div class="menu">
			<div class="menuContent">
				...
				<a href="<?php echo base_url('admin/master_user')?>">Data User</a>
				<a href="<?php echo base_url('admin/master_kos')?>">Data Kost</a>
				<a href="<?php echo base_url('admin/master_pemesanan')?>">Data Pemesanan</a>
			</div>	
			</div>
			<div class="menuContent">
					<?=@$_SESSION['nama'];?>
